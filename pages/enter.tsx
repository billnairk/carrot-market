        ...
        <div className="mt-10">
          <div className="relative">
            ...
            <div className="relative -top-3 text-center">
              <span className="bg-white px-2 text-gray-400 text-sm font-semibold">
                Or enter with
              </span>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-3 mt-2">
            <button className="flex justify-center items-center border border-1 py-3 px-5 rounded-md text-purple-500 hover:bg-purple-200 hover:border-purple-500 hover:transition-all">
              <svg
                className="w-5 h-5"
                aria-hidden="true"
                fill="currentColor"
