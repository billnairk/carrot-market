...
const Profile: NextPage = () => {
  return (
    <Layout hasTabBar title="My">
      <div className="py-4 px-4">
        <div className="flex items-center space-x-3">
          <div className="w-16 h-16 bg-purple-400 rounded-full hover:bg-purple-600 transition-all" />
          <div className="flex flex-col">
            <span className="font-medium text-gray-900">Steve Jebs</span>
            <Link href="/profile/edit">
              <span className="text-sm text-gray-700 hover:font-medium transition-all">
                Edit profile &rarr;
              </span>
            </Link>
          </div>
        ...
        <div className="mt-10 flex justify-around">
          <Link href="/profile/sold">
            <div className=" flex flex-col items-center">
              <div className="w-14 h-14 flex items-center justify-center mb-2 bg-purple-500 rounded-full text-white hover:bg-purple-700 transition-all">
                <svg
                  className="w-6 h-6"
                  fill="none"
                  stroke="currentColor"
        ...
        <div className="mt-5 pt-5 border-t border-gray-300">
          <div className="flex items-center space-x-3">
            ...
            <div className="flex flex-col">
              <h4 className="text-sm font-bold text-gray-900">Miiase</h4>
          ...
          <div className="mt-3 p-3 border border-gray-500 rounded-md">
